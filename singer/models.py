...
class Singer(models.Model):
    ...
    singerImage = models.FileField(upload_to='singers/', verbose_name="封面图", null=True, blank=True)
    ...
    def to_dict(self, request=None):
        cover_url = request.build_absolute_uri(
            os.path.join(settings.MEDIA_URL, self.singerImage.url)) if self.singerImage else None
